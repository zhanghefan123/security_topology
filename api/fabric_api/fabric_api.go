...
const (
	mspID        = "Org1MSP"
	cryptoPath   = "/home/zhf/Projects/emulator/fabric-samples/test-network/organizations/peerOrganizations/org1.example.com"
	certPath     = cryptoPath + "/users/User1@org1.example.com/msp/signcerts"
	keyPath      = cryptoPath + "/users/User1@org1.example.com/msp/keystore"
	tlsCertPath  = cryptoPath + "/peers/peer0.org1.example.com/tls/ca.crt"
	peerEndpoint = "dns:///localhost:5051"
...
func GetContract() (*client.Contract, error) {
...
func TransferAssetAsync(contract *client.Contract, assetId string, owner string) {
